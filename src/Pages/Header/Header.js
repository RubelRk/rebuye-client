...
const Header = () => {
  ...
  const handleSignOut = () =>{
    ...
    <Link className="lg:ml-12 text-base-100 btn btn-ghost normal-case text-xl">RebuyPhone</Link>
  </div>
  ...
  <div className="lg:mr-12 text-base-100 navbar-end">
   { user? <Link onClick={handleSignOut} className='normal-case btn btn-ghost' to='/register'>SignOut</Link> : <Link to='/register'>Register</Link>}
  </div>
</div>
    )
};
