...
const ProductCategories = () => {
  return (
    <div>
      <h3 className="text-center mt-10 mb-2 text-4xl">
        Rebuy Phone Categories{" "}
      </h3>
      ...
      <div className="mx-10 my-10 lg:grid grid-cols-3 gap-4 ">
        ...
        <div className="card lg:w-96 bg-base-300 shadow-2xl">
          ...
          <div className="card-body">
            ...
            <p>
              Refurbished iOS devices will come with new battery and outer
              shell.
            </p>
            <div className="card-actions">
              <button className="normal-case btn btn-primary">
                {" "}
                <Link to={`/allProduct/Apple`}>All Product</Link>{" "}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="my-10 lg:my-0  card lg:w-96 bg-base-300 shadow-2xl">
          ...
          <div className="card-body">
            ...
            <div className="card-actions">
              <button className="normal-case btn btn-primary">
                {" "}
                <Link to={`/allProduct/Samsung`}>All Product</Link>{" "}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="card lg:w-96 bg-base-300 shadow-2xl">
          ...
          <div className="card-body">
            ...
            <p>
              The new and improved refurbished xiaomi phone. Also shop for phone
              at best prices on AliExpress!
            </p>
            <div className="card-actions">
              <button className="normal-case btn btn-primary">
                {" "}
                <Link to={`/allProduct/Xioami`}>All Product</Link>{" "}
              </button>
            </div>
          </div>
        </div>
